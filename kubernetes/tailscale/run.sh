# This file is modified based https://github.com/tailscale/tailscale/blob/9cbb0913bec6b37c019357a8e05b461ee1917a69/docs/k8s/run.sh.
...
TAILSCALED_ARGS="--state=kube:${KUBE_SECRET} --socket=/tmp/tailscaled.sock --debug 0.0.0.0:8080"
